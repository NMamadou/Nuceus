...
public class MetierVarietes {
	 ...
	 */
	public int rechercherVariete(String libelle){
		int pos = -1 ;
		int i = 0 ;
	 ...
	 */
	public List<Variete> consulterVarietes(){
	 ...
	 * @return Variété
	 */
	public Variete consulterVariete(String libelle){
		int pos = rechercherVariete(libelle) ;
		if(pos != -1){
	 ...
	 */
	public boolean ajouterVariete(Variete variete){
		int pos = rechercherVariete(variete.getLibelle());
		if(pos != 1){
	...
	public boolean supprimer(Variete variete){
		return supprimerVariete(variete.getLibelle()) ;
	}
